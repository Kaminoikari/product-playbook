---
name: pmf-gtm
description: Use when the user is assessing product-market fit or planning go-to-market and pricing. Triggers on 'PMF', 'product market fit', 'go to market', 'GTM', 'acquisition channels', 'pricing', 'business model', and the same intent in any language.
---
...
**Provenance:** when you produce PMF/GTM output, contribute the framework tags `PMF` and `GTM` to the meta-skill's provenance line (`— Frameworks: … · PMF · GTM · …`).

## Framework

<!-- migrated from references/05b-pmf-gtm.md (whole file); the Applicable mode/completeness/audience gating lines and the File Integration Tips block are dropped per this phase's migration rules -->
